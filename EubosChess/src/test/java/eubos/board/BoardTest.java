...
public class BoardTest {
	...
	public void test_evaluateKingSafety_notVerySafe()throws IllegalNotationException {
		...
		assertEquals(-78, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.black)); // diagonals 7 squares, can be attacked by two pieces; r'n'f 9 squares can be attacked by three pieces
		assertEquals(-78, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.white));
	}
	...
	public void test_evaluateKingSafety_OneKnight_attackBlack()throws IllegalNotationException {
		...
		assertEquals(0, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.white));
		assertEquals(-68, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.black)); // One knight attacks the black king zone
	}
	...
	public void test_evaluateKingSafety_TwoKnights_attackBlack()throws IllegalNotationException {
		...
		assertEquals(0, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.white));
		assertEquals(-87, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.black)); // One knight attacks the black king zone
	}
	...
	public void test_evaluateKingSafety_OneKnight_attackWhite()throws IllegalNotationException {
		...
		assertEquals(-68, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.white));
	...
	public void test_evaluateKingSafety_TwoKnights_attackWhite()throws IllegalNotationException {
		...
		assertEquals(-87, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.white));
		assertEquals(0, classUnderTest.evaluateKingSafety(pm.getAttacks(), Piece.Colour.black)); // One knight attacks the black king zone
	}
