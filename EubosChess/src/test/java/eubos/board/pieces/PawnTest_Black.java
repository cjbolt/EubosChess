...
public class PawnTest_Black extends PawnTest {
	...
	public void test_InitialBlocked() {
		pm = new PositionManager("8/4p3/4P3/8/8/8/8/8 b - - 0 1 ");
		ml = pm.generateMoves();
	...
	public void test_MoveOneSquare() throws InvalidPieceException {
		...
		pm = new PositionManager("8/4p3/8/8/8/8/4P3/8 b - - 0 1 ");
	...
	public void test_CaptureLeft() {
		pm = new PositionManager("8/4p3/5P2/8/8/8/8/8 b - - 0 1 ");
		ml = pm.generateMoves();
	...
	public void test_CaptureRight() {
		pm = new PositionManager("8/4p3/3P4/8/8/8/8/8 b - - 0 1 ");
		ml = pm.generateMoves();
	...
	public void test_CaptureFork() {
		pm = new PositionManager("8/4p3/3P1P2/8/8/8/8/8 b - - 0 1 ");
		ml = pm.generateMoves();
	...
	public void test_CaptureFromAFile() {
		...
		pm = new PositionManager("8/p7/1P6/8/8/8/8/8 b - - 0 1 ");
		ml = pm.generateMoves();;
	...
	public void test_CaptureFromHFile() {
		...
		pm = new PositionManager("8/7p/6P1/8/8/8/8/8 b - - 0 1 ");
		ml = pm.generateMoves();
