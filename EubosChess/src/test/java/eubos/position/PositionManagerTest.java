...
public class PositionManagerTest {
	...
	public void test_BlackPawn_MoveGen_CaptureEnPassantLeft() throws InvalidPieceException {
		...
		ml = classUnderTest.generateMoves();
		expectedMove = Move.valueOf( Move.TYPE_EN_PASSANT_CAPTURE_MASK, Position.e4, Piece.BLACK_PAWN, Position.f3, Piece.WHITE_PAWN, Piece.NONE );
		contains( expectedMove );
	}
	...
	public void test_BlackPawn_MoveGen_CaptureEnPassantRight() throws InvalidPieceException {
		...
		ml = classUnderTest.generateMoves();
		expectedMove = Move.valueOf( Move.TYPE_EN_PASSANT_CAPTURE_MASK, Position.e4, Piece.BLACK_PAWN, Position.d3, Piece.WHITE_PAWN, Piece.NONE );
		contains( expectedMove );
	}
	...
	public void test_BlackPawn_MoveGen_CaptureEnPassantFromAFile() throws InvalidPieceException {
		...
		ml = classUnderTest.generateMoves();
		expectedMove = Move.valueOf( Move.TYPE_EN_PASSANT_CAPTURE_MASK, Position.a4, Piece.BLACK_PAWN, Position.b3, Piece.WHITE_PAWN, Piece.NONE );
		contains( expectedMove );
	}
	...
	public void test_BlackPawn_MoveGen_CaptureEnPassantFromHFile() throws InvalidPieceException {
		...
		ml = classUnderTest.generateMoves();
		expectedMove = Move.valueOf( Move.TYPE_EN_PASSANT_CAPTURE_MASK, Position.h4, Piece.BLACK_PAWN, Position.g3, Piece.WHITE_PAWN, Piece.NONE );
		contains( expectedMove );
	}		
	...
	public void test_WhitePawn_MoveGen_CaptureEnPassantLeft() throws InvalidPieceException {
		...
		ml = classUnderTest.generateMoves();
		expectedMove = Move.valueOf( Move.TYPE_EN_PASSANT_CAPTURE_MASK, Position.e5, Piece.WHITE_PAWN, Position.d6, Piece.BLACK_PAWN, Piece.NONE );
		contains( expectedMove );
	}
	...
	public void test_WhitePawn_MoveGen_CaptureEnPassantRight() throws InvalidPieceException {
		...
		ml = classUnderTest.generateMoves();
		expectedMove = Move.valueOf(Move.TYPE_EN_PASSANT_CAPTURE_MASK, Position.e5, Piece.WHITE_PAWN, Position.f6, Piece.BLACK_PAWN, Piece.NONE );
		contains( expectedMove );
	}
	...
	public void test_WhitePawn_MoveGen_CaptureEnPassantFromAFile() throws InvalidPieceException {
		...
		ml = classUnderTest.generateMoves();
		expectedMove = Move.valueOf( Move.TYPE_EN_PASSANT_CAPTURE_MASK, Position.a5, Piece.WHITE_PAWN, Position.b6, Piece.BLACK_PAWN, Piece.NONE );
		contains( expectedMove );
	}
	...
	public void test_WhitePawn_MoveGen_CaptureEnPassantFromHFile() throws InvalidPieceException {
		...
		ml = classUnderTest.generateMoves();
		expectedMove = Move.valueOf( Move.TYPE_EN_PASSANT_CAPTURE_MASK, Position.h5, Piece.WHITE_PAWN, Position.g6, Piece.BLACK_PAWN, Piece.NONE );
		contains( expectedMove );
	}		
