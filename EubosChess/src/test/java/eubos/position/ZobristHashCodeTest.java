...
public class ZobristHashCodeTest {
	...
	public void test_update_PerformEnPassantCapture_GivesExpectedHashCode() throws Exception {
		...
		pm.performMove(Move.valueOf(Move.MISC_EN_PASSANT_CAPTURE_MASK, 0, Position.f4, Piece.BLACK_PAWN, Position.e3, Piece.WHITE_PAWN, Piece.NONE));
	...
	public void test_EndGameJustPromotionMove_RegenerateSamePosition() throws Exception {
		...
		pm.performMove(Move.toMove(new GenericMove("a2a1Q"), pm.getTheBoard(), Move.TYPE_PROMOTION_MASK));
	...
	public void test_EndGameJustPromotion_RegenerateSamePosition() throws Exception {
		...
		pm.performMove(Move.valueOf(Move.TYPE_PROMOTION_MASK, Position.a2, Piece.BLACK_PAWN, Position.a1, Piece.NONE, Piece.QUEEN));
		pm.unperformMove();
