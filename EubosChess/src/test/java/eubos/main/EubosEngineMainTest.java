...
public class EubosEngineMainTest {
	...
	// Outputs
	private static final String ID_NAME_CMD = "id name Eubos 1.0.3"+CMD_TERMINATOR;
	...
	public void test_mateInTwo_fromBlack() throws InterruptedException, IOException {
		...
		commands.add(new commandPair(GO_DEPTH_PREFIX+"4"+CMD_TERMINATOR,BEST_PREFIX+"b4d5"+CMD_TERMINATOR));
		performTest(1000);
	}	
