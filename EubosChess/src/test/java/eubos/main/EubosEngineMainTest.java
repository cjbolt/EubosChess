...
public class EubosEngineMainTest {
	...
	private static final String OPTION_HASH = "option name Hash type spin default 905 min 32 max 4000"+CMD_TERMINATOR;
	...
	public void test_infoMessageSending() throws InterruptedException, IOException {
		if (EubosEngineMain.UCI_INFO_ENABLED) {
			...
			/* originally caused a bad info message to be generated, f3e5 and c7c2 are not cleared from the first PV in the ext search...
