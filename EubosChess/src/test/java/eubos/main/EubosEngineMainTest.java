...
public class EubosEngineMainTest extends AbstractEubosIntegration {
	...
	public void tearDown() throws IOException, InterruptedException {
		System.err.println("-----------------doing tearDown");
		shutdownEngine();
	}
	...
	void init(TestInfo testInfo) throws IOException {
	    String displayName = testInfo.getDisplayName();
	 	System.err.println("-----------------doing setUp-----" + displayName);
	 	startupEngine(displayName);
	}
	...
	public void test_mateInTwo() throws InterruptedException, IOException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"6"+CMD_TERMINATOR,BEST_PREFIX+"b5b6"+CMD_TERMINATOR));
	...
	public void test_mate_in_3() throws InterruptedException, IOException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"3"+CMD_TERMINATOR, BEST_PREFIX+"d7e6"+CMD_TERMINATOR));
	...
	public void test_WAC009() throws InterruptedException, IOException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"10"+CMD_TERMINATOR,BEST_PREFIX+"d6h2"+CMD_TERMINATOR));
		// 2
	...
	@Test
	@Disabled // Unsure why it is failing, reports correct move
	...
	public void test_mate_in_3_guardian3713() throws InterruptedException, IOException {
		...
		assertTrue(performTestExpectMate(4000, 3));
	}
	...
	public void test_tricky_endgame_position() throws InterruptedException, IOException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"14"+CMD_TERMINATOR, BEST_PREFIX+"e5g3"+CMD_TERMINATOR));
		assertTrue(performTest(15000));
	}
	...
	@Test
	public void test_draw_weirdness() throws InterruptedException, IOException {
		setupEngine();
		commands.add(new CommandPair(POS_START_PREFIX+"moves e2e4 c7c5 g1f3 d7d6 d2d4 c5d4 f3d4 g8f6 b1c3 a7a6 f2f3 e7e6 c1e3 c8d7 f1c4 d7c6 e1g1 d8a5 d1d3 c6d7 a2a3 b8c6 b2b4 a5d8 d4c6 d7c6 d3d4 f6d7 a1d1 c6b5 c4b5"+CMD_TERMINATOR, null));
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"6"+CMD_TERMINATOR, BEST_PREFIX+"a6b5"+CMD_TERMINATOR));
		assertTrue(performTest(1000));
	}
	...
	public void test_createPositionFromAnalyseCommand() throws IllegalNotationException, InterruptedException, IOException {
		...
		classUnderTest.sendBestMoveCommand(new SearchResult(Move.valueOfBit(BitBoard.b3, Piece.BLACK_KING, BitBoard.b4, Piece.NONE), 162));
		// White move 63
		applyMoveList = new ArrayList<GenericMove>();
		applyMoveList.add(new GenericMove("b3b4"));
		classUnderTest.createPositionFromAnalyseCommand(new EngineAnalyzeCommand(new GenericBoard("8/8/8/8/8/pk6/8/K7 b - - 5 62"), applyMoveList));
		classUnderTest.sendBestMoveCommand(new SearchResult(Move.valueOfBit(BitBoard.a1, Piece.WHITE_KING, BitBoard.a2, Piece.NONE), -92));
		// Black move 63
		applyMoveList = new ArrayList<GenericMove>();
		applyMoveList.add(new GenericMove("b3b4"));
		applyMoveList.add(new GenericMove("a1a2"));
		classUnderTest.createPositionFromAnalyseCommand(new EngineAnalyzeCommand(new GenericBoard("8/8/8/8/8/pk6/8/K7 b - - 5 62"), applyMoveList));
		classUnderTest.sendBestMoveCommand(new SearchResult(Move.valueOfBit(BitBoard.b4, Piece.BLACK_KING, BitBoard.a4, Piece.NONE), 162));
		// White move 64
		applyMoveList = new ArrayList<GenericMove>();
		applyMoveList.add(new GenericMove("b3b4"));
		applyMoveList.add(new GenericMove("a1a2"));
		...
		classUnderTest.createPositionFromAnalyseCommand(new EngineAnalyzeCommand(new GenericBoard("8/8/8/8/8/pk6/8/K7 b - - 5 62"), applyMoveList));
		classUnderTest.sendBestMoveCommand(new SearchResult(Move.valueOfBit(BitBoard.a2, Piece.WHITE_KING, BitBoard.b1, Piece.NONE), -112));
		//  Black move 64
		applyMoveList = new ArrayList<GenericMove>();
		applyMoveList.add(new GenericMove("b3b4"));
		applyMoveList.add(new GenericMove("a1a2"));
		...
		classUnderTest.createPositionFromAnalyseCommand(new EngineAnalyzeCommand(new GenericBoard("8/8/8/8/8/pk6/8/K7 b - - 5 62"), applyMoveList));
		classUnderTest.sendBestMoveCommand(new SearchResult(Move.valueOfBit(BitBoard.a4, Piece.BLACK_KING, BitBoard.a5, Piece.NONE), 152));
	...
	public void test_WAC_086_position() throws InterruptedException, IOException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"15"+CMD_TERMINATOR, BEST_PREFIX+"f6g4"+CMD_TERMINATOR));
	...
	public void test_endgame_o() throws IllegalNotationException, IOException, InterruptedException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"18"+CMD_TERMINATOR, BEST_PREFIX+"e5f4"+CMD_TERMINATOR));
		assertTrue(performTest(1000));
	}
	...
	@Test
	@Disabled // Latest NN insists on d6c7, need to comprehend that with a strong engine reference
	public void test_endgame_Fine_80() throws IllegalNotationException, IOException, InterruptedException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"18"+CMD_TERMINATOR, BEST_PREFIX+"b6b5"+CMD_TERMINATOR));
		assertTrue(performTest(20000));
	}
	...
	public void test_endgame_Fine_67() throws IllegalNotationException, IOException, InterruptedException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"15"+CMD_TERMINATOR, BEST_PREFIX+"b3b4"+CMD_TERMINATOR));
		assertTrue(performTest(2000));		
	}
	...
	public void test_endgame_Fine_76() throws IllegalNotationException, IOException, InterruptedException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"14"+CMD_TERMINATOR, BEST_PREFIX+"f3f4"+CMD_TERMINATOR));
		assertTrue(performTest(1000));	
	}
	...
	public void test_endgame_Fine_100A() throws IllegalNotationException, IOException, InterruptedException {
		...
		commands.add(new CommandPair(GO_DEPTH_PREFIX+"7"+CMD_TERMINATOR, BEST_PREFIX+"e2d2"+CMD_TERMINATOR));
		assertTrue(performTest(1000));		
	}
