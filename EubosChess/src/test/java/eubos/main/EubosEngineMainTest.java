	...
	public void test_infoMessageSending_clearsPreviousPvMoves() throws InterruptedException, IOException {
		if (EubosEngineMain.ENABLE_UCI_INFO_SENDING) {
			...
			if (Board.ENABLE_PIECE_LISTS && PositionEvaluator.ENABLE_DYNAMIC_POSITIONAL_EVALUATION && PositionEvaluator.ENABLE_KING_SAFETY_EVALUATION && EubosEngineMain.ENABLE_QUIESCENCE_CHECK) {
				expectedOutput = "info depth 1 seldepth 6 score cp -17 pv d7e5 f3e5 c7c2 e5f7 hashfull 0 nps 347 time 69 nodes 24"+CMD_TERMINATOR+
	                    "info depth 1 seldepth 6 score cp 177 pv c7c2 d4a7 hashfull 0 nps 652 time 69 nodes 45"+CMD_TERMINATOR+
	                    "info depth 2 seldepth 6 score cp 133 pv c7c2 e1g1 d7e5 hashfull 0 nps 2505 time 85 nodes 213"+CMD_TERMINATOR
	                    +BEST_PREFIX+"c7c2";
