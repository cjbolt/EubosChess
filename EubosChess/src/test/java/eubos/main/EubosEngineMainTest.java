...
public class EubosEngineMainTest {
	...
	// Outputs
	private static final String ID_NAME_CMD = "id name Eubos 1.0.2"+CMD_TERMINATOR;
	private static final String ID_AUTHOR_CMD = "id author Chris Bolt"+CMD_TERMINATOR;
	private static final String OPTION_HASH = "option name Hash type spin default 925 min 32 max 4000"+CMD_TERMINATOR;
