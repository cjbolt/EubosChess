...
public class MiniMaxMoveGeneratorTest {
	...
	public void test_findMove_WhitePawnCapture() throws IllegalNotationException {
		...
		classUnderTest = new MiniMaxMoveGenerator( pm,pm,pm, SEARCH_DEPTH_IN_PLY );
	...
	public void test_findMove_pinnedPawn2()  throws NoLegalMoveException, IllegalNotationException {
		...
		classUnderTest = new MiniMaxMoveGenerator(pm,pm,pm,2);
		expectedMove = new GenericMove("e6f5");
		doFindMoveTest(false);
	}
	...
	public void test_findMove_mateInThree_WhiteMated() throws InvalidPieceException, IllegalNotationException {
		...
		classUnderTest = new MiniMaxMoveGenerator(pm,pm,pm,4);
	...
	public void test_findMove_crashLichess_CloudFunction() throws InvalidPieceException, IllegalNotationException {
		...
		classUnderTest = new MiniMaxMoveGenerator(pm,pm,pm,5);
	...
	public void test_findMove_crashLichess_General_Yummy() throws InvalidPieceException, IllegalNotationException {
	    /*  [Site "https://lichess.org/V3MPFEkl"]
			...
			[UTCDate "2018.06.29"]
			[UTCTime "19:41:08"] */
		PositionManager pm = new PositionManager( "rnb2bnr/1ppp2pp/p4k2/5PN1/3Q4/2P5/PP3P1P/R1B1K1R1 b Q - 3 14");
		classUnderTest = new MiniMaxMoveGenerator(pm,pm,pm,5);
