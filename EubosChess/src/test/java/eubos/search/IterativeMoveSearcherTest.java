...
public class IterativeMoveSearcherTest {
	...
	@Test
	public void test_endgame_b()throws IllegalNotationException {
	...
	public void test_endgame_d()throws IllegalNotationException {
		setupPosition("8/pp5p/8/PP2k3/2P2pp1/3K4/6PP/8 w - - 1 10", 12000*IterativeMoveSearcher.AVG_MOVES_PER_GAME);
	...
	@Test
	public void test_endgame_k()throws IllegalNotationException  {
	...
	@Test
	public void test_findMove_mateInThree() throws IllegalNotationException {
