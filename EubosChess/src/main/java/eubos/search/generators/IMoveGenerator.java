...
public interface IMoveGenerator {
	...
	public SearchResult findMove(byte searchDepth, List<Integer> lastPc, SearchMetrics sm, SearchMetricsReporter sr) throws NoLegalMoveException, InvalidPieceException;
}
