...
public class MaterialEvaluator {
    ...
    static {
    	PAWN_WHITE_WEIGHTINGS = new int[256];
    ...
    static {
    	PAWN_BLACK_WEIGHTINGS = new int[256];
    ...
    static {
    	KING_ENDGAME_WEIGHTINGS = new int[256];
    ...
    static {
    	KING_MIDGAME_WEIGHTINGS = new int[256];
