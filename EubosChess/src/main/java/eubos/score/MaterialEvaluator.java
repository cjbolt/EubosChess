...
public class MaterialEvaluator {
    ...
    static {
        ...
        aMap.put(GenericPosition.a5, 0);aMap.put(GenericPosition.b5, 3);aMap.put(GenericPosition.c5, 5);aMap.put(GenericPosition.d5, 15);aMap.put(GenericPosition.e5, 15);aMap.put(GenericPosition.f5, 5);aMap.put(GenericPosition.g5, 3);aMap.put(GenericPosition.h5, 0);
		aMap.put(GenericPosition.a6, 5);aMap.put(GenericPosition.b6, 25);aMap.put(GenericPosition.c6, 25);aMap.put(GenericPosition.d6, 25);aMap.put(GenericPosition.e6, 25);aMap.put(GenericPosition.f6, 25);aMap.put(GenericPosition.g6, 25);aMap.put(GenericPosition.h6, 10);
