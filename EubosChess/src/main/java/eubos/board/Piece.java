...
public abstract class Piece {
    ...
    static {
    	...
    	PIECE_SQUARE_TABLES[Piece.WHITE_ROOK] = ZERO_WEIGHTING;
    	...
    	PIECE_SQUARE_TABLES[Piece.BLACK_ROOK] = ZERO_WEIGHTING;
    ...
    static {
    	...
    	ENDGAME_PIECE_SQUARE_TABLES[Piece.WHITE_PAWN] = PAWN_WHITE_WEIGHTINGS;
    	...
    	ENDGAME_PIECE_SQUARE_TABLES[Piece.BLACK_PAWN] = PAWN_BLACK_WEIGHTINGS;
