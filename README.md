...
It is currently rated around 2800 Elo against other engines, not humans (this is at blitz 2+1 time control, see  http://ccrl.chessdom.com/ccrl/404/).
...
4.x | Changed to neural net based evaluation function (1x128 hidden layer, trained using a database of self-generated supervised learning)
...
As of version 4.x it uses a neural net based evaluation function (all prior versions were hand crafted evaluation).
...
Thanks to the author of the lichess-bot API as well.
